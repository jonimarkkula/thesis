...
void initializeBrakePowerArray(){
	...
	for(int i = 1; i < 12; i++){
		...
		brakePowerRange[i] = brakePowerRange[i-1] + 0.02;
	}
...
/*Function that turns Led's on depending on currently measured acceleration*/
...
/*Function that turns all leds on after calibration has been done*/
